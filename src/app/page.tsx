...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-6 sm:py-24 lg:py-36 relative w-full">
          ...
          <div className="text-center max-w-4xl mx-auto relative z-10">
            ...
            <p className="mt-2 sm:mt-4 text-sm sm:text-lg leading-relaxed text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-12 px-4">
              Connect with expert consultants who can guide you through every step of your career journey. 
              From school students to working professionals, we have the right mentor for everyone.
            </p>
            <div className="mt-6 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4">
              <Button asChild size="lg" className="w-full sm:w-auto text-base sm:text-xl px-6 sm:px-10 py-4 sm:py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <Link href="#categories">
                  Explore Categories
                  <ArrowRight className="ml-2 sm:ml-3 h-4 w-4 sm:h-6 sm:w-6" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="w-full sm:w-auto text-base sm:text-xl px-6 sm:px-10 py-4 sm:py-6 border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 font-semibold transition-all duration-300">
                <Link href="/signup">
                  Get Started
                </Link>
              </Button>
      ...
      {/* Categories Section */}
      <section id="categories" className="py-24 bg-white dark:bg-gray-900 relative">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-20">
            ...
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Select the area where you need expert guidance and book a consultation session
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <ExpandableCategories categories={transformCategories(categories)} />
          )}
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Connect with verified industry experts and experienced professionals
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Get tailored advice based on your specific goals and circumstances
              </p>
            </div>
      ...
      <footer className="bg-gray-900 dark:bg-black text-white">
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <Image
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white">CarrierHub</h3>
              </div>
              <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed">
                Your trusted partner in career development. Connect with expert consultants 
                and unlock your potential with personalized guidance.
              </p>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start text-gray-300">
                  ...
                  <span className="text-xs sm:text-sm break-all">support@carrierhub.com</span>
                </div>
                ...
                <div className="flex items-start text-gray-300">
                  ...
                  <span className="text-xs sm:text-sm leading-relaxed">
                    Landewadi, Bhosari, Pune,<br className="sm:hidden" />
            ...
            <div className="mt-8 sm:mt-0">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="#categories" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center group text-sm sm:text-base">
                    <BookOpen className="w-3 h-3 sm:w-4 sm:h-4 mr-2 group-hover:text-blue-400 flex-shrink-0" />
                    Browse Categories
                  </Link>
                </li>
                <li>
                  <Link href="/signup" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center group text-sm sm:text-base">
                    <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 mr-2 group-hover:text-green-400 flex-shrink-0" />
                    Get Started
                  </Link>
                </li>
                <li>
                  <Link href="/login" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center group text-sm sm:text-base">
                    <Users className="w-3 h-3 sm:w-4 sm:h-4 mr-2 group-hover:text-purple-400 flex-shrink-0" />
                    Login
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center group text-sm sm:text-base">
            ...
            <div className="mt-8 sm:mt-0">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="#" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center group text-sm sm:text-base">
